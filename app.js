...
const siteConfig = {
  ...
  entries: [
    ...
    {
      publishedAt: "2026-08-14 09:54",
      kind: "酒馆公益",
      name: "ArityFlow",
      summary: "主要面向酒馆用户，按次计费；每天可以签到，最高 50，并提供小克和免费模型。",
      details:
        "站点采用按次计费方式，适合酒馆用户按需调用。除 coding 分组外，站方会严格检查编程行为，违规可能导致封号。",
      registration: "通过邀请链接注册。",
      dailyCheckin: "最高 50",
      models: "小克 / 免费模型",
      experience: "按次计费，主要面向酒馆用户",
      caveat: "严查除 coding 分组以外的编程行为，违规可能封号。",
      benefits: ["每日签到最高 50", "按次计费", "酒馆用户", "小克", "免费模型"],
