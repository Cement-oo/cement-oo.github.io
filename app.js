...
const siteConfig = {
  ...
  entries: [
    ...
    {
      publishedAt: "2026-08-14 09:58",
      kind: "限时开放",
      name: "ArityFlow",
      summary: "老站现已限时重开，主要面向酒馆用户，按次计费；每天可以签到，最高 50。",
      details:
        "本次为限时开放，站点提供小克和免费模型，适合酒馆用户按需调用。除 coding 分组外，站方会严格检查编程行为，违规可能导致封号。",
      registration: "通过邀请链接注册。",
      dailyCheckin: "最高 50",
      models: "小克 / 免费模型",
      experience: "按次计费，主要面向酒馆用户",
      caveat: "严查除 coding 分组以外的编程行为，违规可能封号。",
      benefits: ["老站限时重开", "每日签到最高 50", "按次计费", "酒馆用户", "小克", "免费模型"],
    ...
    {
      publishedAt: "2026-08-14 09:33",
      kind: "随缘注册",
      name: "TabiToken",
      summary: "注册窗口不固定，开放时间摸不准，有空可以自行试试；原邀请注册额度为 120 刀。",
      details:
        "主打 Claude Opus 4.8 和 Opus 5，速度快、连接稳定。注册状态可能随时变化，平时有空可以自己打开链接试试。",
      registration: "注册窗口不固定，建议有空时自行尝试。",
      signupBonus: "120 刀",
      dailyCheckin: "5-10 刀",
      models: "Claude Opus 4.8 / Opus 5",
      experience: "速度快、稳定",
      caveat: "开放时间不固定，页面状态可能和实际注册窗口存在延迟。",
      benefits: ["原注册送 120 刀", "每日签到", "随缘注册", "有空可自行尝试"],
    ...
    },
    {
      ...
      kind: "随缘注册",
      name: "GoRouter",
      summary: "注册窗口不固定，开放时间摸不准，有空可以自行试试；原邀请注册额度为 70 刀。",
      details:
        "主打 Claude Opus 4.8 和 Opus 5，速度和稳定性都不错。注册状态可能随时变化，平时有空可以自己打开链接试试；已注册用户请尽快调用，否则有封号风险。",
      registration: "注册窗口不固定，建议有空时自行尝试。",
      signupBonus: "70 刀",
      dailyCheckin: "5-10 刀",
      models: "Claude Opus 4.8 / Opus 5",
      ...
      benefits: ["原注册送 70 刀", "每日签到", "随缘注册", "已注册请尽快调用"],
