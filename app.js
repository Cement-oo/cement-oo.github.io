...
const siteConfig = {
  ...
  entries: [
    ...
    },
    {
      ...
      kind: "暂停注册",
      name: "GoRouter",
      summary: "目前已关闭注册；恢复开放后会及时更新，原邀请注册额度为 70 刀。",
      details:
        "主打 Claude Opus 4.8 和 Opus 5，速度和稳定性都不错。目前暂时无需尝试注册，已注册用户请尽快调用，否则有封号风险。",
      registration: "目前暂停注册，等待重新开放。",
      signupBonus: "70 刀",
      dailyCheckin: "5-10 刀",
      models: "Claude Opus 4.8 / Opus 5",
      experience: "速度快、稳定",
      caveat: "注册已关闭；已注册用户请尽快调用，否则有封号风险。",
      benefits: ["原注册送 70 刀", "每日签到", "暂时关闭注册", "已注册请尽快调用"],
